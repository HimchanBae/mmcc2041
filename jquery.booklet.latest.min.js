...
(function (a) {
    ...
    if (typeof k === "string") {
      ...
      a(this).each(function () {
        ...
        if (i) {
          ...
          a.error(
            'jQuery.booklet has not been initialized. Method "' +
              k +
              '" cannot be called.'
          );
        }
  ...
  function b(bg, a7) {
    var aH = bg,
      ...
      aY,
      E = {
        create: "bookletcreate",
        start: "bookletstart",
        change: "bookletchange",
        add: "bookletadd",
        remove: "bookletremove",
      },
      L,
      a5 = function (h, bi, bh) {
        var j = "",
        ...
        if (
          bh.pageNumbers &&
          !h.hasClass("b-page-empty") &&
          (!bh.closed ||
            (bh.closed && !bh.covers) ||
            (bh.closed && bh.covers && bi != 1 && bi != bh.pageTotal - 2))
        ) {
      ...
      aQ = function () {
        ...
        L = {
          ...
          pages: [
            u[aI.currentIndex].contentNode,
            u[aI.currentIndex + 1].contentNode,
          ],
        };
        if (aI.create) {
      ...
      r = function () {
        ...
        if (aI.closed) {
          a(o.empty)
            .attr({
              title: aI.closedFrontTitle || "",
              rel: aI.closedFrontChapter || "",
            })
            .prependTo(aH);
          aH.children()
            .last()
            .attr({
              title: aI.closedBackTitle || "",
              rel: aI.closedBackChapter || "",
            });
          aH.append(o.empty);
        }
        ...
        if (!au) {
          ...
          if (
            !isNaN(aI.startingPage) &&
            aI.startingPage <= aI.pageTotal &&
            aI.startingPage > 0
          ) {
      ...
      Z = function () {
        ...
        if (aI.currentIndex - 2 >= 0) {
          aH.find(".b-page-" + (aI.currentIndex - 2))
            .addClass("b-pN")
            .show();
          aH.find(".b-page-" + (aI.currentIndex - 1))
            .addClass("b-p0")
            .show();
        }
        aH.find(".b-page-" + aI.currentIndex)
          .addClass("b-p1")
          .show();
        aH.find(".b-page-" + (aI.currentIndex + 1))
          .addClass("b-p2")
        ...
        if (aI.currentIndex + 3 <= aI.pageTotal) {
          aH.find(".b-page-" + (aI.currentIndex + 2))
            .addClass("b-p3")
            .show();
          aH.find(".b-page-" + (aI.currentIndex + 3))
            .addClass("b-p4")
            .show();
        }
        V = aH.find(".b-pN");
      ...
      aJ = function () {
        aH.find(".b-shadow-f, .b-shadow-b, .b-p0, .b-p3").css({
          filter: "",
          zoom: "",
        });
        ...
        if (
          aI.closed &&
          aI.autoCenter &&
          (aI.currentIndex == 0 || aI.currentIndex >= aI.pageTotal - 2)
        ) {
          if (aI.overlays) {
            B.width("100%");
          }
      ...
      ak = function () {
        ...
        aH.find(
          ".b-counter, .b-page-blank, .b-page-empty, .b-shadow-f, .b-shadow-b"
        ).remove();
        if (aI.direction == aO.rightToLeft) {
          a(aH.children().get().reverse()).each(function () {
            a(this).appendTo(aH);
      ...
      a6 = function (i) {
        ...
        if (!aI.width) {
          ...
          if (typeof aI.width == "string" && aI.width.indexOf("px") != -1) {
            ...
            if (typeof aI.width == "string" && aI.width.indexOf("%") != -1) {
              ...
              ap = aI.width;
              aI.width =
                (aI.width.replace("%", "") / 100) *
                parseFloat(aH.parent().css("width"));
            }
          }
        }
        if (!aI.height) {
          ...
          if (typeof aI.height == "string" && aI.height.indexOf("px") != -1) {
            ...
            if (typeof aI.height == "string" && aI.height.indexOf("%") != -1) {
              ...
              I = aI.height;
              aI.height =
                (aI.height.replace("%", "") / 100) *
                parseFloat(aH.parent().css("height"));
            }
          }
        }
        aH.width(aI.width);
                ...
                d.find("a").on("click.booklet", function (j) {
                  ...
                  if (aI.direction == aO.rightToLeft) {
                    ...
                    F(
                      Math.abs(
                        parseInt(
                          a(this).attr("id").replace("selector-page-", "")
                        ) - aI.pageTotal
                      ) - 2
                    );
                  } else {
                    F(
                      parseInt(a(this).attr("id").replace("selector-page-", ""))
                    );
                  }
                });
              }
              ...
              if (u[ag].chapter != "" && typeof u[ag].chapter != "undefined") {
                ...
                if (!aI.hash) {
                  a8.find("a").on("click.booklet", function (bh) {
                    ...
                    if (aI.direction == aO.rightToLeft) {
                      aK.find(".b-current").text(
                        a(this).find(".b-text").text()
                      );
                      j =
                        Math.abs(
                          parseInt(
        ...
        if (aI.overlays && B.length == 0) {
          aZ = a(
            '<div class="b-overlay b-overlay-prev b-prev" title="' +
              aI.previousControlTitle +
              '"></div>'
          ).appendTo(aU);
          a0 = a(
            '<div class="b-overlay b-overlay-next b-next" title="' +
              aI.nextControlTitle +
              '"></div>'
          ).appendTo(aU);
          B = aH.find(".b-overlay");
        ...
        if (aI.tabs && aq.length == 0) {
          aV = a(
            '<div class="b-tab b-tab-prev b-prev" title="' +
              aI.previousControlTitle +
              '">' +
              aI.previousControlText +
              "</div>"
          ).appendTo(aU);
          aX = a(
            '<div class="b-tab b-tab-next b-next" title="' +
              aI.nextControlTitle +
              '">' +
              aI.nextControlText +
              "</div>"
        ...
        if (aI.tabs && aq.length > 0) {
          ...
          if (aI.direction == aO.rightToLeft) {
            aX.html(aI.previousControlText).attr(
              "title",
              aI.previousControlTitle
            );
        ...
        if (aI.arrows && x.length == 0) {
          T = a(
            '<div class="b-arrow b-arrow-prev b-prev" title="' +
              aI.previousControlTitle +
              '"><div>' +
              aI.previousControlText +
              "</div></div>"
          ...
          U = a(
            '<div class="b-arrow b-arrow-next b-next" title="' +
              aI.nextControlTitle +
              '"><div>' +
              aI.nextControlText +
              "</div></div>"
          ...
          x = aH.find(".b-arrow");
          if (aI.direction == aO.rightToLeft) {
            U.html("<div>" + aI.previousControlText + "</div>").attr(
              "title",
              aI.previousControlTitle
            );
            T.html("<div>" + aI.nextControlText + "</div>").attr(
              "title",
              aI.nextControlTitle
            );
          }
        ...
        a(document).on("keyup.booklet", function (j) {
          if (j.keyCode == 37 && aI.keyboard) {
            M();
          } else {
            if (j.keyCode == 39 && aI.keyboard) {
              aM();
            }
          }
        });
      ...
      ac = function () {
        aN = {
          wrap: {
            left: 0,
            width: K - aI.pagePadding * 2 - aI.pageBorder * 2,
            height: y - aI.pagePadding * 2 - aI.pageBorder * 2,
            padding: aI.pagePadding,
          },
          p0wrap: { right: 0, left: "auto" },
          p1: { left: 0, width: K, height: y },
          p2: { left: K, width: K, opacity: 1, height: y },
          pN: { left: 0, width: K, height: y },
          p0: { left: 0, width: 0, height: y },
          p3: { left: K * 2, width: 0, height: y, paddingLeft: 0 },
          p4: { left: K, width: K, height: y },
          sF: { right: 0, width: K, height: y },
          sB: { left: 0, width: K, height: y },
        };
        e = 10;
        a1 = aI.hoverWidth + e;
        C = aI.hoverWidth / 2 + e;
        am = {
          hover: {
            ...
            size: aI.hoverWidth,
            p2: { width: K - C },
            p3: { left: aI.width - a1, width: C },
            p3closed: { left: K - aI.hoverWidth, width: C },
            p3wrap: { left: e },
            p2end: { width: K },
            p2closedEnd: { width: K, left: 0 },
            p3end: { left: aI.width, width: 0 },
            p3closedEnd: { left: K, width: 0 },
            p3wrapEnd: { left: 10 },
            p1: { left: C, width: K - C },
            p1wrap: { left: "-" + C + "px" },
            p0: { left: C, width: C },
            p0wrap: { right: e },
            p1end: { left: 0, width: K },
            p1wrapEnd: { left: 0 },
            p0end: { left: 0, width: 0 },
            p0wrapEnd: { right: 0 },
          },
          p2: { width: 0 },
          p2closed: { width: 0, left: K },
          p4closed: { left: K },
          p3in: { left: av, width: av, paddingLeft: aI.shadowBtmWidth },
          p3inDrag: {
            left: K / 4,
            width: K * 0.75,
            paddingLeft: aI.shadowBtmWidth,
          },
          p3out: { left: 0, width: K, paddingLeft: 0 },
          p3wrapIn: { left: aI.shadowBtmWidth },
          p3wrapOut: { left: 0 },
          p1: { left: K, width: 0 },
          p1wrap: { left: ar },
          p0: { left: K, width: K },
          p0in: { left: av, width: av },
          p0out: { left: K, width: K },
          p0outClosed: { left: 0, width: K },
          p2back: { left: 0 },
          p0wrapDrag: { right: 0 },
          p0wrapIn: { right: aI.shadowBtmWidth },
          p0wrapOut: { right: 0 },
        };
      },
      a3 = function () {
      ...
      v = function () {
        if (aI.pageSelector) {
          ...
          if (aI.direction == aO.rightToLeft) {
            h =
              Math.abs(aI.currentIndex - aI.pageTotal) -
              1 +
              " - " +
              Math.abs(aI.currentIndex - aI.pageTotal);
            if (aI.closed) {
              if (aI.currentIndex == aI.pageTotal - 2) {
                ...
                if (aI.currentIndex == 0) {
                  ...
                  h =
                    ...
                    2 +
                    " - " +
                    (Math.abs(aI.currentIndex - aI.pageTotal) - 1);
                }
              }
              if (aI.covers) {
                if (aI.currentIndex == aI.pageTotal - 2) {
                  ...
                  if (aI.currentIndex == 0) {
                    ...
                    h =
                      ...
                      3 +
                      " - " +
                      (Math.abs(aI.currentIndex - aI.pageTotal) - 2);
                  }
                }
              }
            }
        ...
        if (aI.chapterSelector) {
          if (u[aI.currentIndex].chapter != "") {
            a(aI.menu + " .b-selector-chapter .b-current").text(
              u[aI.currentIndex].chapter
            );
          } else {
            if (u[aI.currentIndex + 1].chapter != "") {
              a(aI.menu + " .b-selector-chapter .b-current").text(
                u[aI.currentIndex + 1].chapter
              );
            }
          }
          if (
            aI.direction == aO.rightToLeft &&
            u[aI.currentIndex + 1].chapter != ""
          ) {
            a(aI.menu + " .b-selector-chapter .b-current").text(
              u[aI.currentIndex + 1].chapter
      ...
      N = function () {
        ...
        if (a.ui) {
          ...
          if (aI.manual) {
            ...
            aG.draggable({
              ...
              stop: function () {
                ...
                if (i > aI.hoverThreshold) {
                  ...
                  be.animate({ opacity: 0 }, am.hover.speed, aI.easing).css(
                    aN.sB
                  );
                  s = false;
            ...
            aH.off("mousemove.booklet")
              .on("mousemove.booklet", function (bp) {
      ...
      a9 = function (h) {
        ...
        if (
          aH.children(".b-page").length == 2 &&
          aH.find(".b-page-blank").length > 0
        ) {
          return;
        }
        ak();
        ...
        if (h < aI.pageTotal && h >= 0 && !aj && !Q) {
          if (h > aI.currentIndex) {
            ...
            L = {
              options: a.extend({}, aI),
              index: h,
              pages: [u[h].contentNode, u[h + 1].contentNode],
            };
            if (aI.start) {
            ...
            if (aL) {
              ...
              aB.stop()
                .animate(am.p3in, i, aI.easeIn)
                .animate(am.p3out, i, aI.easeOut);
              k.animate(am.p3wrapIn, i, aI.easeIn).animate(
                am.p3wrapOut,
                i,
                aI.easeOut,
                function () {
            ...
            if (h < aI.currentIndex) {
              ...
              if (s) {
                ...
                if (aI.closed && aI.autoCenter && aI.currentIndex == 0) {
                  aG.animate(am.p0in, i, aI.easeIn).animate(
                    am.p0outClosed,
                    i,
                    aI.easeOut
                  );
                ...
                aP.animate(am.p0wrapIn, i, aI.easeIn).animate(
                  am.p0wrapOut,
                  i,
                  aI.easeOut,
                  function () {
        ...
        if (!Q && ((aI.hovers && aI.overlays) || aI.manual)) {
          if (h) {
            if (
              ...
              !aR &&
              !aL &&
              aI.currentIndex + 2 <= aI.pageTotal - 2
            ) {
        ...
        if (!Q && ((aI.hovers && aI.overlays) || aI.manual)) {
          if (h) {
            if (!aj && f && !aL && aI.currentIndex + 2 <= aI.pageTotal - 2) {
              if (aI.closed && aI.autoCenter && aI.currentIndex == 0) {
                aD.stop().animate(
                  am.hover.p2closedEnd,
                  am.hover.speed,
                  aI.easing
                );
                aB.stop().animate(
                  am.hover.p3closedEnd,
                  am.hover.speed,
                  aI.easing
                );
              } else {
      ...
      G = function (j, i, bh, h) {
        if (i && j > 2) {
          ...
          aH.find(".b-page-" + (aI.currentIndex + 1))
            ...
            .show()
            .css(aN.p4);
          aH.find(".b-page-" + aI.currentIndex + " .b-wrap")
            .show()
            .css(aN.wrap);
          aH.find(".b-page-" + (aI.currentIndex + 1) + " .b-wrap")
            .show()
            .css(aN.wrap);
          aB = aH.find(".b-p3");
          ay = aH.find(".b-p4");
